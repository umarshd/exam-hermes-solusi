    ...
    <nav id="sidebar" class="sidebar js-sidebar">
      <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="index.html">
          <span class="align-middle">App Penjualan</span>
        </a>
        ...
        <ul class="sidebar-nav">
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="<?= base_url() ?>/admin/transaksi">
              <i class="align-middle" data-feather="shopping-bag"></i> <span class="align-middle">Transaksi</span>
            </a>
          </li>
          ...
          <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                <p class="dropdown-item"><i class="align-middle me-1" data-feather="user"></i>
                  <?= session()->get('email') ?>
                </p>
